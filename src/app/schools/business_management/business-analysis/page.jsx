...
export default function BusinessManagemnt() {
  ...
  const feData = {
    ...
    outline: [
      ...
      'Prepare for Business Management job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
    ...
    careerParagraph: 'Get ready to step into a role of a Business Manager',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as Business Manager',
    ],
  };
