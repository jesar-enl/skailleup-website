...
export default function DigitalMarketing() {
  ...
  const feData = {
    head: 'School of Digital Marketing',
    description:
      'Welcome to the cutting-edge realm of the School of Digital Marketing. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image3',
    ...
    outline: [
      ...
      'Prepare for Digital Marketing job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
    ...
    careerParagraph: 'Get ready to step into a role of a Digital Marketier',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as Digital Marketier',
    ],
  };
