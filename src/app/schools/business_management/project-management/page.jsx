...
export const metadata = {
  title: 'School of Project Management',
  description:
    'Find more about what we have to offer you for a successful career.',
};

export default function ProjectManagemnt() {
  // TODO: course outline is needed.
  // TODO: background image is needed.
  const feData = {
    head: 'School of Project Management',
    description:
      'Welcome to the cutting-edge realm of the School of Project Management. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image3',
    ...
    outline: [
      ...
      'Prepare for Project Management job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
    ...
    careerParagraph: 'Get ready to step into a role of a Project Manager',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as Project Manager',
    ],
  };
