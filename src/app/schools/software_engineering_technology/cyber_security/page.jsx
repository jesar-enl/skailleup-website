...
export default function CyberSecurity() {
  const feData = {
    head: 'School of Cyber Security',
    description:
      'Welcome to the cutting-edge realm of the School of Cyber Security. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image6',
    ...
    outline: [
      ...
      'Gain insights into popular Cyber Security techniques, enabling you to build robust and interactive web applications.',
      ...
      'Prepare for Cyber Security job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
    ...
    careerList: [
      ...
      'Become eligible for sought-after positions as Cyber Security Officer',
    ],
  };
