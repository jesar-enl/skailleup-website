...
export default function SoftwareEngineering() {
  const seData = {
    ...
    description:
      'Welcome to the cutting-edge realm of the School of Software Engineering. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image2',
    ...
    careerParagraph: 'Get ready to step into a role of a Software Engineer',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as Software Engineer',
    ],
  };
  ...
  return (
    <div className="bg-gray-100">
      <Hero data={seData} />
      <Terms />
      <Description data={seData} />
      <Requirements />
      <CourseOutline data={seData} />
      <Pricing data={seData} />
      <CareerOpprtunity data={seData} />
    </div>
  );
}
