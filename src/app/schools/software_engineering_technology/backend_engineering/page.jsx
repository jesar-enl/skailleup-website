...
export const metadata = {
  title: 'School of Backend Engineering',
  description:
...
export default function BackendEngineering() {
  const feData = {
    head: 'School of Backend Engineering',
    description:
      'Welcome to the cutting-edge realm of the School of Backend Engineering. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image4',
    ...
    outline: [
      ...
      'Prepare for Backend engineering job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
