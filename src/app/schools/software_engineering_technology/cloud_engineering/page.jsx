...
export const metadata = {
  title: 'School of Cloud Engineering',
  description:
...
export default function CloudEngineering() {
 const feData = {
   head: 'School of Cloud Engineering',
   description:
     'Welcome to the cutting-edge realm of the School of Cloud Engineering. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
   image: 'image5',
   ...
   outline: [
     ...
     'Prepare for Cloud Engineering job interview by honing your skills and building a strong profile of projects.',
   ],
   packageData: [
     {
       index: 'string1',
   ...
   careerParagraph: 'Get ready to step into a role of a Cloud Engineer',
   careerList: [
     'Showcase your skills through portfolio-ready projects',
     'Achieve your Diploma Certificate',
     'Become eligible for sought-after positions as Cloud Engineer',
   ],
 };
