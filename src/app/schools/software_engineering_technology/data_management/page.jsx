...
export const metadata = {
  title: 'School of Data Management',
  description:
...
export default function DataManipulation() {
  const feData = {
    head: 'School of Data Manipulation',
    description:
      'Welcome to the cutting-edge realm of the School of Data Manipulation. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image7',
    ...
    outline: [
      ...
      'Prepare for Data Manipulation job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
    ...
    careerParagraph: 'Get ready to step into a role of a Data Analyist',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as Data Analyist',
    ],
  };
