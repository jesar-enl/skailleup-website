...
export const metadata = {
  title: 'Schools of Programming Languages',
  description:
...
export default function ProgrammingLanguages() {
  const feData = {
    head: 'School of Programming Languages',
    description:
      'Welcome to the cutting-edge realm of the School of Programming Languages. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image11',
    ...
    outline: [
      ...
      'Gain insights into popular Backend frameworks like Django, enabling you to build robust and interactive web applications.',
      ...
      'Prepare for Programming Languages job interview by honing your skills and building a strong profile of projects.',
    ],
    packageData: [
      {
        index: 'string1',
    ...
    careerParagraph: 'Get ready to step into a role of a Backend Engineer',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as Backend Engineer',
    ],
  };
