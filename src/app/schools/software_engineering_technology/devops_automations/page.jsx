...
export default function DevOps() {
  const feData = {
    head: 'School of DevOps & Automations',
    description:
      'Welcome to the cutting-edge realm of the School of DevOps & Automations. We transcend the boundaries of convectional learning. Here, knowledge meets creativity, and curiosity fuels a journey of digital discovery.',
    image: 'image8',
    ...
    outline: [
      ...
      'Gain insights into popular DevOps & Automations, enabling you to build robust and interactive web applications.',
    ...
    careerParagraph: 'Get ready to step into a role of a DevOp',
    careerList: [
      'Showcase your skills through portfolio-ready projects',
      'Achieve your Diploma Certificate',
      'Become eligible for sought-after positions as DevOp',
    ],
  };
